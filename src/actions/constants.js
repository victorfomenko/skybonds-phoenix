...
export const LAYER_SEARCH_RESPONSE = 'LAYER_SEARCH_RESPONSE';
export const LAYER_SEARCH_DAILY = 'LAYER_SEARCH_DAILY';
export const LAYER_GET_PLACEHOLDER_BONDS = 'LAYER_GET_PLACEHOLDER_BONDS';
